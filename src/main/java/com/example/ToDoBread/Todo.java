// TODO API creation - Entity class
// Entity class is a class that maps to a database table. It is a blueprint for creating objects.
/*
...
Entity classes are blueprints for creating objects that represent rows in the 
...
The @GeneratedValue(strategy = GenerationType.IDENTITY) annotation specifies that 
the id should be generated automatically by the database using an identity column, 
...
This annotation generates boilerplate code such as getters, setters, 
toString(), equals(), and hashCode() methods, reducing the amount of code 
